    ...
    <h3>회원가입</h3>
      ...
      <form ref="form">
        <div>
          ...
          <input type="text" class="form-control" id="username" ref='usernameRef' v-model="username"  required>
        </div>
        <div>
          <label for="userid" class="form-label">아이디</label>
          <input type="text" class="form-control" id="userid" ref='useridRef' v-model="userid" required>
        </div>
        <div>
